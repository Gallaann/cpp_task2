...
Ваш вариант:
Добавьте к существующим операциям grep <substr> - которая передает дальше или выводит только те строки, которые содержат подстроку <substr>
Строка <substr> не допускает пробелов
